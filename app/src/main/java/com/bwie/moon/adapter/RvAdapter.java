...
public class RvAdapter extends RecyclerView.Adapter<RvAdapter.MyViewHolder> {
    ...
    public RvAdapter(Context context, List<Drink> datas) {
        super();
...
//        }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View contentView = LayoutInflater.from(context).inflate(R.layout.recycle_item, parent, false);
...
//            imageView = (ImageView) itemView.findViewById(R.id.recyclerView_TextView);
            tv = (TextView) itemView.findViewById(R.id.recyclerView_TextView);
        }
    }
